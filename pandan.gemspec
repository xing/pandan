...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Retrieve Xcode dependency information with ease.}
  spec.description   = %q{CLI tool that outputs dependency information from a set of Xcode projects with targets that depend on each other, it does it by creating a (reverse) dependency graph and doing a breadth-first search.}
